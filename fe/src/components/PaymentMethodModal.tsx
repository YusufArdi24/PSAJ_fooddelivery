...
const PaymentMethodModal = ({ isOpen, onClose, onConfirm, isPlacingOrder = false }: PaymentMethodModalProps) => {
            ...
            <div className="p-6 border-b border-border">
              <div className="flex items-start justify-between">
                ...
                <Button
                  ...
                  className="h-8 w-8 p-0 ml-4 hover:bg-muted/50 transition-all duration-200 hover:rotate-90 flex-shrink-0 disabled:opacity-50"
                >
                  <X className="w-4 h-4" />
                </Button>
              </div>
