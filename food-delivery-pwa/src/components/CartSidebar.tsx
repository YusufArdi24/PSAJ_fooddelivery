...
const CartSidebar = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed right-0 top-0 h-full w-96 bg-card border-l border-border z-50 flex flex-col animate-in slide-in-from-right-2 duration-300 shadow-2xl">
        {/* Header */}
        ...
        {cartItems.length > 0 && (
          <div className="p-4 border-t border-border animate-in slide-in-from-bottom-2 duration-1200">
            <Button
              ...
              className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground transition-all duration-200 hover:scale-105 hover:shadow-lg"
            >
